...
const Staking = () => {
  ...
  return (
      <iframe width="100%" height="800px" src="https://www.spatial.io/s/Marbleverse-633c3595b4f3e70001089a4d?share=3281566939575842343" allow="microphone https://spatial.io; camera https://spatial.io"></iframe>
  )
}
